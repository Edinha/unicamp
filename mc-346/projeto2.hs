...
-- A ideia dessa solução é juntar os vértices em componentes até que o número de grupos seja igual a k
-- Se a unificação for feita com a ordem crescente de peso das arestas, temos uma k-árvore geradora mínima
