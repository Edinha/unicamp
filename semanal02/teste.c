...
int main() {
    ...
    printf("Largura : %lf\n", (xMaiorBorda - xMenorBorda));
    printf("Altura : %lf\n", (yMaiorBorda - yMenorBorda));
    printf("Area retangulo : %lf\n", (xMaiorBorda - xMenorBorda) * (yMaiorBorda - yMenorBorda));
    ...
    printf("Galoes : %d\n", qtdGaloes);
    printf("Litros * dias : %lf\n", litros * qtdFestival);
    printf("Litros inteiros : %d\n", litrosInteiros);
    printf("LitrosInteiros * dias : %d\n", litrosInteiros * qtdFestival);
